...
/**
 * Fires when a scheduled reminder alarm triggers.
 * Creates a high-priority notification so the user sees it.
 */
class ReminderReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        Log.i(TAG, "Reminder fired: id=$reminderId label=$label")
        ...
        // Remove from stored reminders now that it has fired
    ...
    private fun removeStoredReminder(context: Context, id: Int) {
        val prefs = context.getSharedPreferences("andyclaw_reminders", Context.MODE_PRIVATE)
