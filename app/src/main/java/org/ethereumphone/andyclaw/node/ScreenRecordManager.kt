...
import org.ethereumphone.andyclaw.PermissionRequester
import org.ethereumphone.andyclaw.ScreenCaptureRequester
...
class ScreenRecordManager(private val context: Context) {
  ...
  suspend fun record(paramsJson: String?): Payload =
    withContext(Dispatchers.Default) {
      ...
      val file = File.createTempFile("andyclaw-screen-", ".mp4")
